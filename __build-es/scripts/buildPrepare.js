...
components.forEach(function (component) {
  ...
  mkdirp(componentDir).then(function (mkdirpErr) {
    ...
    var componentContent = "export { default } from '../__build-es/".concat(component, "';\nexport * from '../__build-es/").concat(component, "';\n");
...
fs.readFile(packageJsonPath, 'utf-8', function (readFileErr, packageJsonData) {
  ...
  var newPackageJson = _objectSpread(_objectSpread({}, packageJson), {}, {
    files: ['cjs/**/*', '__build-es/**/*'].concat((0, _toConsumableArray2["default"])(components.map(function (component) {
