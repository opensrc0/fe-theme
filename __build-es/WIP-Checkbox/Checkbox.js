...
var _fontColorConstnst = _interopRequireDefault(require("../component/theme/font/fontColorConstnst"));
var _fontWeightConstnst = _interopRequireDefault(require("../component/theme/font/fontWeightConstnst"));
...
var CheckboxText = _styledComponents["default"].span.withConfig({
  ...
  return _fontColorConstnst["default"][props.checkboxColor];
}, function (props) {
  return _fontWeightConstnst["default"][props.fontWeight];
});
var CheckboxCheckmark = _styledComponents["default"].span.withConfig({
  displayName: "Checkbox__CheckboxCheckmark",
  componentId: "sc-1wes6rm-3"
})(["background:", ";position:absolute;top:0;left:2px;width:18px;height:18px;outline:none;border:1px solid #cfcfcf;&::after{content:\"\";position:absolute;display:none;left:4px;top:2px;width:5px;height:8px;border:solid white;border-width:0 2px 2px 0;transform:rotate(45deg);}"], _fontColorConstnst["default"].white);
var CheckboxError = _styledComponents["default"].p.withConfig({
  displayName: "Checkbox__CheckboxError",
  componentId: "sc-1wes6rm-4"
})(["font-size:12px;line-height:14px;font-weight:500;color:", ";margin-top:6px;margin-bottom:6px;padding-left:4px;"], _fontColorConstnst["default"].danger);
var CheckboxInput = _styledComponents["default"].input.withConfig({
  displayName: "Checkbox__CheckboxInput",
  componentId: "sc-1wes6rm-5"
})(["color:black;font-size:16px;font-weight:400;font-family:'Open Sans',sans-serif;display:inline-block;border:none;border-bottom:1px solid #cfcfcf;background-color:transparent;padding-left:20px;outline:none;box-shadow:none;position:absolute;opacity:0;cursor:pointer;left:0;height:100%;margin:0;line-height:normal;&:checked ~ ", "{&::before{display:block;}&::after{display:block;left:4px;top:1px;width:5px;height:10px;}}&:checked ~ ", "{background-color:", ";border:1px solid ", ";}", " &:disabled ~ ", "{background:", ";cursor:not-allowed;}"], CheckboxCheckmark, CheckboxCheckmark, _fontColorConstnst["default"].blackLight, _fontColorConstnst["default"].blackLight, function (props) {
  return [props.theme === 'secondary' && (0, _styledComponents.css)(["&:checked ~ ", "{background-color:", ";border:1px solid ", ";}"], CheckboxCheckmark, _fontColorConstnst["default"].darkBlue, _fontColorConstnst["default"].darkBlue), props.theme === 'success' && (0, _styledComponents.css)(["&:checked ~ ", "{background-color:", ";border:1px solid ", ";}"], CheckboxCheckmark, _fontColorConstnst["default"].green, _fontColorConstnst["default"].green), props.theme === 'primary' && (0, _styledComponents.css)(["&:checked ~ ", "{background-color:", ";border:1px solid ", ";}"], CheckboxCheckmark, _fontColorConstnst["default"].red, _fontColorConstnst["default"].red), props.theme === 'primary' && (0, _styledComponents.css)(["&:checked ~ ", "{background-color:", ";border:1px solid ", ";}"], CheckboxCheckmark, _fontColorConstnst["default"].red, _fontColorConstnst["default"].red)];
}, CheckboxCheckmark, _fontColorConstnst["default"].gray3);
...
Checkbox.propTypes = {
  ...
  fontWeight: _propTypes["default"].oneOf(Object.keys(_fontWeightConstnst["default"])),
